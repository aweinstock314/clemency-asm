...
if __name__ == '__main__':
    ...
    print "# AUTOGENERATED BY gen/parse_ini.py"
    print "# MODIFY THE GENERATOR INSTEAD OF THIS"
    print
    print "enc_fun_to_dec_fun = {}"
    print "enc_fun_to_fields = {}"
    print "enc_fun_to_size= {}"
    ...
    for line in f:
        ...
        print "enc_fun_to_fields[enc_{name}] = [{fields}]".format(name=name.lower(), fields=", "
            .join("(%r,%d,%d)" % (name, start, end) for (name, (start, end)) in zip(arg_name, zip(arg_start_pos, arg_pos))))
        print "enc_fun_to_size[enc_{name}] = {size}".format(name=name.lower(), size=size)
        print
